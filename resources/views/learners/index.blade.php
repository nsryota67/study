...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="create_note">
            [<a href='learners/create_note'>ノートを作成する</a>]
        </div>

        <div class="set_quiz">
            [<a href='/learners/create_quiz/{{ Auth::user()->id }}'>クイズを作成する</a>]
        </div>
        ...
        <div class="set_goal">
            [<a href='goals/goal/{{ Auth::user()->id }}'>目標を設定する</a>]
        </div>
